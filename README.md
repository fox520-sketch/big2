...
v0.6.6 是免 Cloud Functions 版。請勿使用 v0.7.0 的 Firestore Rules；更新後請務必把本版 `firestore.rules` 貼到 Firebase Console → Firestore Database → Rules → Publish。
...
- v0.6.6 內容強化清單：`docs/GAME_CONTENT_CHECKLIST.md`
...
請把解壓縮後資料夾裡面的檔案放到 GitHub repository 根目錄，不要把整個 `big2-tw-v0.6.6` 資料夾丟上去，否則 GitHub Pages 可能找不到 `index.html`。
