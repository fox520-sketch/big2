...
if(pkg.version!=='0.8.4') throw new Error('package 版本不是 0.8.4');
const index=fs.readFileSync(new URL('../index.html',import.meta.url),'utf8');
if(!(index.includes('正式上線驗收與問題回報') || index.includes('正式發布候選版（RC）')) || !index.includes('docs/FINAL_ACCEPTANCE_CHECKLIST.md')) throw new Error('首頁缺少正式驗收／RC 區塊');
