...
if(pkg.version!=='1.0.0') throw new Error('package 版本不是 1.0.0');
const index=fs.readFileSync(new URL('../index.html',import.meta.url),'utf8');
if(!(index.includes('正式上線驗收與問題回報') || index.includes('正式穩定發布版')) || !index.includes('docs/FINAL_ACCEPTANCE_CHECKLIST.md')) throw new Error('首頁缺少正式驗收／RC 區塊');
