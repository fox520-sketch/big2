...
for (const text of ['v0.7.2', '首頁流程', '新手教學模式', '發布檢查清單', '免 Cloud Functions', '手機牌桌 UI 優化']) {
...
if (!constants.includes("VERSION = '0.7.2'")) {
  throw new Error('src/constants.js 版本不是 0.7.2');
}
