...
for (const text of ['v1.0.1', '首頁流程', '新手教學模式', '發布檢查清單', '免 Cloud Functions', '手機牌桌 UI 優化']) {
...
if (!constants.includes("VERSION = '1.0.1'")) {
  throw new Error('src/constants.js 版本不是 1.0.1');
}
