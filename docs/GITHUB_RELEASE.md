...
1. 將 v1.0.1 檔案 Commit 並 Push 到 `main`。
2. 到 repository 的 **Releases**。
3. 點 **Draft a new release**。
4. 建立新標籤 `v1.0.1`，目標選 `main`。
5. 貼上上方 Release 標題與內容。
6. 附加 `big2-tw-v1.0.1.zip` 作為 Source code 以外的方便下載檔。
